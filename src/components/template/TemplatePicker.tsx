...
export default function TemplatePicker({
  ...
  return (
    <section className="w-full bg-white dark:bg-[#0f0f11] border-b border-slate-200 dark:border-white/[0.06] py-4 px-6 select-none shrink-0">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  transition-all duration-150 w-full min-h-[120px]
                  ${
                    isActive
